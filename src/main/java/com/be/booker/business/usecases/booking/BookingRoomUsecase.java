...
public class BookingRoomUsecase {
    ...
    private void bookingRoom() {
        ...
        Booking roomBookingEntity = new Booking();
        roomBookingEntity.setRoomName(roomBookingDto.getRoomName());
        roomBookingEntity.setUserLogin(roomBookingDto.getUserLogin());
        roomBookingEntity.setBookedFrom(roomBookingDto.getBookedFrom());
        roomBookingEntity.setBookedTo(roomBookingDto.getBookedTo());
        bookingRepository.save(roomBookingEntity);
    }
}
