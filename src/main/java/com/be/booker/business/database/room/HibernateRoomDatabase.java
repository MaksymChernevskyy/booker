...
@ConditionalOnProperty(name = "com.be.booker.business.database.room", havingValue = "hibernate")
@Repository
public class HibernateRoomDatabase implements RoomDatabase {
  ...
  public Optional<Room> save(Room room) {
    ...
    try {
      ...
      throw new RepositoryOperationException("An error while saving room.", e);
    }
  }
  ...
  public Optional<Room> findById(Long id) {
    ...
    try {
      ...
      throw new RepositoryOperationException("An error while searching for room.", e);
    }
  }
  ...
  public long count() {
    try {
      ...
      throw new RepositoryOperationException("An error while counting rooms.", e);
    }
  }
  ...
  public void deleteById(Long id) {
    ...
    try {
      ...
      throw new RepositoryOperationException("There was no room in database.", e);
    }
  }
  ...
  public void deleteAll() {
    try {
      ...
      throw new RepositoryOperationException("An error while deleting all rooms.", e);
    }
  }
}
