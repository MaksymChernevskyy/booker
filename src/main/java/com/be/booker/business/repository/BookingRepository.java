...
public interface BookingRepository extends JpaRepository<Booking, Long> {
  ...
  @Query("select booking from Booking booking where ?1  <= booking.bookedFrom and booking.bookedTo <= ?2 and booking.roomName = ?3")
  ...
  @Query("select booking from Booking booking where ?1  <= booking.bookedFrom and booking.bookedTo <= ?2 and booking.userLogin = ?3")
